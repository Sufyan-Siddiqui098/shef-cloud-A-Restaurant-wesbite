                      ...
                      <div className="flex items-center gap-x-2 w-[80%]">
                        ...
                        <h3 className="mb-1 text-lg font-semibold leading-tight">
                          ...
                          <div className="flex flex-col">
                            <p className="text-xs my-0 text-headGray mt-[2px] tracking-wider">
                              Date:{" "}
                              {new Date(chef.delivery_date).toDateString()}
                            </p>
                            <p className="text-[10px] mt-1 xl:text-xs my-0 text-headGray tracking-wider">
                              Slot:{" "}
                              {convertTo12Hour(
                                chef.delivery_slot?.split("-")[0]
                              ) +
                                " - " +
                                convertTo12Hour(
                                  chef.delivery_slot?.split("-")[1]
                                )}
                            </p>
                          </div>
                        </h3>
