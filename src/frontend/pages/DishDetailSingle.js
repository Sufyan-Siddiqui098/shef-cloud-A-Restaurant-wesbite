                                ...
                                <div className='md:w-2/3 w-full'>
                                    <div className='flex gap-3 mb-3 border-b'>
                                        <div
                                            ...
                                            className={activeDescTab === 1 ? '!border-b-2 !border-primary cursor-pointer font-semibold text-lg' : 'cursor-pointer text-lg'}
                                        >
                                            Description
                                        </div>
                                        <div
                                            onClick={() => descTabClick(2)}
                                            className={activeDescTab === 2 ? '!border-b-2 !border-primary cursor-pointer font-semibold text-lg' : 'cursor-pointer text-lg'}
                                        >
                                            Main ingredients
                                        </div>
                                    </div>
                                ...
                                <label className="flex items-center justify-between cursor-pointer border border-borderClr rounded-lg px-3 py-4 prtionRadio" htmlFor="portion_1">
                                    <div className='flex items-center gap-x-3 '>
                                        ...
                                        <div className=''>
                                            ...
                                            <h6 className='text-[12px] text-primaryGreen mb-0 mr-3'>Shef recommend</h6>
                                        </div>
