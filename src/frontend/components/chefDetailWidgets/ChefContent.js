        ...
        <>
            <div className='pb-16 pt-8 lg:px-2 px-4'>
                <div className='container mx-auto'>
                    <img src='./media/frontend/img/shef-detail/defaultImage.png' className='object-top rounded-[16px] w-full object-cover h-[250px]' alt='Chef Cover' />
                    <div className='flex lg:flex-row flex-col gap-4 lg:mt-[-80px] mt-[-200px] px-3'>
                        <div className='lg:w-[270px] md:w-[35%] w-full'>
                            <img src='./media/frontend/img/banner/female-chef.png' className='object-top rounded-[16px] w-full object-cover lg:h-full h-[260px] border-[5px] border-white' alt='Love Local Chef' />
                        </div>
                        <div className='w-full'>
                            <div className='flex lg:flex-row flex-col lg:items-center lg;justify-between lg:pt-[100px] md:pt-4 pt-2'>
                                <div className='flex items-center gap-x-2'>
                                    <h1 className='text-2xl font-semibold mb-0'>Shef Swarnamali</h1>
                                    <div className='rounded-sm py-1 px-2 flex items-center gap-x-2'>
                                ...
                                <div className='flex md:flex-nowrap flex-wrap gap-2'>
                                    ...
                                    <div className='inline-flex items-center border border-primaryLight rounded px-2 py-1'>
                                        ...
                                        <h4 className='mb-0 text-sm pl-1'>9 Dishes</h4>
                                    </div>
                                    <div className='inline-flex items-center border border-primaryLight rounded px-2 py-1'>
