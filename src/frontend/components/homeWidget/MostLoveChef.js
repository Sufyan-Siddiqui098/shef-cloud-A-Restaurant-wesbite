                                        ...
                                        <div className='chefSlidInner p-5'>
                                            <div className='grid grid-cols-12 md:gap-x-4 gap-x-0 md:gap-y-0 gap-y-4'>
                                                <div className='md:col-span-5 col-span-12 relative'>
                                                    <img src={(chef.profile_pic && chef.profile_pic[0]!=='p') ? chef.profile_pic : './media/frontend/img/banner/female-chef.png'} className='object-top rounded-lg w-full object-cover h-[190px]' alt='Love Local Chef' />
                                                    {/* Verified tag */}
                                                    { chef?.email_verified_at && <div className='absolute bottom-3 right-3 bg-white rounded-sm py-1 px-2 flex items-center gap-x-2'>
                                                ...
                                                <div className='md:col-span-7 col-span-12'>
                                                    ...
                                                    <p className='mt-4'>
                                                        {chef.bio.length>200 ? `${chef?.bio?.substring(0, 200)}...` : chef.bio }
                                                    </p>
                                                </div>
                                            </div>
