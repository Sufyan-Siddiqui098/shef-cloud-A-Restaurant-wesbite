...
const DetailStep = ({
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        const formatedTags = tagResponse.map((tag) => {
  ...
  useEffect(() => {
    if (tags && tags.length > 0) {
      const temp = tagOptions.filter((item) =>
        tags.split(", ").some((elem) => elem === item.value)
      );
    ...
    <div>
      <div className="container mx-auto">
        <div className="lg:w-2/3 sm:w-4/5 w-full mx-auto">
          <h2 className="text-2xl font-semibold border-b mb-8 pb-2">
            Dish Detail
          </h2>
          <div className="">
          ...
          <div>
            ...
            <div
              className="grid md:grid-cols-6 grid-cols-3 gap-3 mb-4"
              id="group1"
            >
              {/* Types */}
              {foodType.map((type, index) => (
                <label
                  key={type.id}
                  className="flex items-center justify-center cursor-pointer rounded-md px-3 border border-borderClr py-4 p-relative foodTypeRadio"
                >
                  <div className="text-center">
                    <div className="mb-3">
                      ...
                      <img
                        src={type.image}
                        alt={type.name}
                        className="mx-auto aspect-square h-[30px] w-[30px]"
                      />
                    </div>
                    <h4 className="text-[14px] font-bold mb-0 leading-tight">
                      {type.name}
                    </h4>
                  </div>
                  <input
                    type="radio"
                    className="form-radio text-primary w-[16px] h-[16px] hidden"
                    onChange={() => updateFields({ food_type_id: type.id })}
                    checked={food_type_id === type.id}
                    name="group1"
                    value={type.id}
                  />
                </label>
          ...
          <div className="mt-4">
            <div className="flex items-center gap-3">
              <div className="md:w-[70%]">
                <h3 className="text-lg font-semibold mb-1 leading-tight">
                  Does this main need a side?
                </h3>
                <p className="text-[12px] mb-1">
                  Let us know if the customer needs to purchase a side item
                  (e.g. rice, bread or a vegatable) separately for this dish.
                </p>
              </div>
              <div className="md:w-[30%]">
                ...
                <div
                  className="flex items-center justify-end bg-grayBg rounded-lg p-2"
                  id="sideID"
                >
                  <label className="flex items-center justify-between cursor-pointer rounded-md w-1/2 px-3 py-2 p-relative dietaryRadio">
                    ...
                    <input
                      ...
                      name="sideID"
                      value="1"
                      onChange={() => updateFields({ side_item: 1 })}
                    />
                  </label>
                  <label className="flex items-center justify-between cursor-pointer rounded-md w-1/2 px-3 py-2 dietaryRadio">
                    ...
                    <input
                      ...
                      checked={side_item === 0}
                      value="0"
                      onChange={() => updateFields({ side_item: 0 })}
                    />
                  </label>
                </div>
              </div>
          ...
          <div className="rounded-lg bg-grayBg p-4">
            ...
            <p className="text-[12px]">
              Add up to 5 cuisine tags for your dish. You can arrange the tags
            ...
            <div className="rounded-lg bg-grayBg pt-4">
              ...
              <ul className="mb-0 mt-2 pl-5">
                <li className="list-disc leading-tight mb-1">
                  Select up to 7 dish tags that best describe this dish.
                </li>
                <li className="list-disc leading-tight mb-1">
                  We’ve included some of the tags from your cuisine profile,
                  remove any that do not apply to this dish.
                </li>
                <li className="list-disc leading-tight mb-1">
                  These selections will help your customers find your dish, so
                  be sure to only select tags that describe it well.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="">
            <div className="flex sm:flex-row flex-col justify-between sm:items-center items-start gap-4">
              <div>
                ...
                <h4 className="text-base font-normal mb-0 leading-tight">
                  Base serving size
                </h4>
              </div>
              <button
                onClick={openServSizeModal}
            ...
            <div className="rounded-lg bg-grayBg p-4 mt-4">
              ...
              <ul className="mb-0 mt-2 pl-5">
                <li className="list-disc leading-tight mb-1">
                  Single serving mains and 1 or 1-2 serving sides are our most
                  popular dishes.
                </li>
                <li className="list-disc leading-tight mb-1">
                  Your base serving price will be what customers see most often.
                  Make sure it's priced as competitively as possible.
                </li>
                <li className="list-disc leading-tight mb-1">
                  You can use the price recommendation provided as a guide,
                  we’ve based it off of other top selling dishes in your city.
                </li>
                <li className="list-disc leading-tight mb-1">
                  Lower-priced dishes with a generous portion size typically
                  sell best, especially for new dishes.
                </li>
                <li className="list-disc leading-tight mb-1">
                  When dishes are priced too high, customers tend to opt for
                  other items—setting higher prices does not mean that you’ll
                  make more money.
                </li>
                <li className="list-disc leading-tight mb-1">
                  If you do choose to set your prices above these
                  recommendations, we recommend you make the value clear to your
                  customer.
                </li>
              </ul>
            </div>
