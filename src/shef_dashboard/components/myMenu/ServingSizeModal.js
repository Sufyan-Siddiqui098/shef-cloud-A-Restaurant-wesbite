...
const MenuModal = ({
  ...
  return (
    ...
    >
      ...
      <div className="pt-6">
        <p>
          Add portion and price information for the smallest serving you want to
          offer. Next you can add options for larger portion sizes.
        </p>
        <p className="font-semibold">
          We recommend setting 1 serving as the smallest portion for most
          dishes.
        </p>
        ...
        <div>
          {activeTab === 1 && (
            <div>
              ...
              <div>
                <div>
                  ...
                  <p className="text-[12px]">
                    This should be your smallest serving for this dish. You can
                    add larger options on the next page.
                  </p>
                </div>
                <select
                  ref={inputRefBaseServing}
                  value={portion_type_id}
                  onChange={handleBaseServing}
                  id="selectOption"
                >
              ...
              <div className="md:flex-row flex-col md:items-center items-start justify-between gap-2 mt-6">
                <div className="w-[80%]">
                  <h3 className="text-lg font-semibold mb-1 leading-tight">
                    Base price for this portion
                  </h3>
                  <p className="text-[12px] mb-1">
                    We recommend setting a price that ends with either .49 or
                    .99
                  </p>
                </div>
              ...
              <div className="rounded-lg bg-grayBg p-4 mt-4">
                ...
                <ul className="mb-0 mt-2 pl-5">
                  ...
                  <li className="list-disc leading-tight mb-1">
                    Your base serving price will be what customers see most
                    often. Make sure it's priced as competitively as possible.
                  </li>
                  <li className="list-disc leading-tight mb-1">
                  ...
                  <li className="list-disc leading-tight mb-1">
                    ...
                    recommendations, we recommend you make the value clear to
                    your customer.
                  </li>
                </ul>
              </div>
          ...
          <div className="flex items-center justify-end mt-4 gap-2">
            <button type="button" onClick={onCancel} className="shefBtnBorder">
              Cancel
            </button>
            <button
              onClick={onSubmit}
              type="submit"
              className="text-lg font-bold bg-primaryDark px-[22px] py-[6px] uppercase text-white rounded-[6px] disabled:opacity-60"
            >
              Submit
            </button>
          </div>
