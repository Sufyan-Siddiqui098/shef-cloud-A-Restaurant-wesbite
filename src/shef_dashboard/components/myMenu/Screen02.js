        ...
        <div className="lg:w-2/3 sm:w-4/5 mx-auto">
          ...
          <div className="">
            ...
            <p className="text-[12px]">
              Dish Description: Tell customers about your dish.
            </p>
            <textarea
              ref={descriptionRef}
              className="h-[130px]"
              ...
              onChange={(e) => {
                ...
                const backspaceKeyPressed =
                  currentDescription.length === newDescription.length + 1;
                if (
                  backspaceKeyPressed ||
          ...
          <div className="rounded-lg bg-grayBg mt-4 p-4">
            ...
            <ul className="mb-0 mt-2 pl-5">
              <li className="list-disc leading-tight mb-1">
                Do NOT give any options to modify dish such as “spicy or not
                spicy”, “this dish can be made vegan”, etc.
              </li>
              <li className="list-disc leading-tight mb-1">
                Do NOT make health claims such as “high protein dish”, “will
                heal you”, “will make you lose weight”, etc.
              </li>
            </ul>
          </div>
          <div className="rounded-lg bg-grayBg mt-4 p-4">
            ...
            <ul className="mb-0 mt-2 pl-5">
              <li className="list-disc leading-tight mb-1">
                Include the top two flavors and ingredients
              </li>
              <li className="list-disc leading-tight mb-1">
                Describe the consistency
              </li>
              <li className="list-disc leading-tight mb-1">
                Add a personal detail or historical fact about your dish
              </li>
              <li className="list-disc leading-tight mb-1">
                Specify exactly what will come with your dish, like any
                garnishes or sides
              </li>
            </ul>
          </div>
          ...
          <div className="">
            ...
            <p className="text-[12px]">
              How many of this item you want to offer on a delivery day (1-100).
            </p>
            <input
              type="number"
              min={0}
          ...
          <div>
            ...
            <p className="text-[12px]">
              Delivery days this dish will be available on your menu. You can
              also edit this from your availability page.
            </p>
            <div className="grid md:grid-cols-7 grid-cols-4 cols-4 gap-3">
              <label className="flex items-center justify-between cursor-pointer border rounded-md  px-3 py-6 daysCheckbox">
                ...
                <input
                  ...
                  onChange={(e) => {
                    is_monday === 1
                      ? updateFields({ is_monday: 0 })
                      : updateFields({ is_monday: 1 });
                  }}
                  name=""
                  value={is_monday}
                />
              ...
              <label className="flex items-center justify-between cursor-pointer rounded-md border px-3 py-6 daysCheckbox">
                ...
                <input
                  ...
                  onChange={(e) => {
                    is_tuesday === 1
                      ? updateFields({ is_tuesday: 0 })
                      : updateFields({ is_tuesday: 1 });
                  }}
                  name=""
                  value={is_tuesday}
                />
              ...
              <label className="flex items-center justify-between cursor-pointer rounded-md border px-3 py-6 daysCheckbox">
                ...
                <input
                  ...
                  onChange={(e) => {
                    is_wednesday === 1
                      ? updateFields({ is_wednesday: 0 })
                      : updateFields({ is_wednesday: 1 });
                  }}
                  name=""
                  value={is_wednesday}
                />
              ...
              <label className="flex items-center justify-between cursor-pointer rounded-md border px-3 py-6 daysCheckbox">
                ...
                <input
                  ...
                  onChange={(e) => {
                    is_thursday === 1
                      ? updateFields({ is_thursday: 0 })
                      : updateFields({ is_thursday: 1 });
                  }}
                  name=""
                  value={is_thursday}
                />
              ...
              <label className="flex items-center justify-between cursor-pointer rounded-md border px-3 py-6 daysCheckbox">
                ...
                <input
                  ...
                  onChange={(e) => {
                    is_friday === 1
                      ? updateFields({ is_friday: 0 })
                      : updateFields({ is_friday: 1 });
                  }}
                  name=""
                  value={is_friday}
                />
              ...
              <label className="flex items-center justify-between cursor-pointer rounded-md border px-3 py-6 daysCheckbox">
                ...
                <input
                  ...
                  onChange={(e) => {
                    is_saturday === 1
                      ? updateFields({ is_saturday: 0 })
                      : updateFields({ is_saturday: 1 });
                  }}
                  name=""
                  value={is_saturday}
                />
              ...
              <label className="flex items-center justify-between cursor-pointer rounded-md border px-3 py-6 p-relative daysCheckbox">
                ...
                <input
                  ...
                  onChange={(e) => {
                    is_sunday === 1
                      ? updateFields({ is_sunday: 0 })
                      : updateFields({ is_sunday: 1 });
                  }}
                  name=""
                  value="value1"
                />
          ...
          <div>
            ...
            <p className="text-[12px]">
              Use this feature if you want to limit this item's availability on
              a specific calendar date or date range.
            </p>
            <div>
              <select
                value={
                  limit_item_availibility === null
                    ? ""
                    : limit_item_availibility
                }
                onChange={OnItemAvailabilityChange}
                id="selectOption"
              >
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-3 mt-5">
              <div>
                ...
                <p className="text-[12px]">Date item will become available</p>
                <input
                  disabled={
                    !limit_item_availibility ||
                    limit_item_availibility.length < 1
                  }
                  onChange={(e) =>
                    updateFields({ limit_start: e.target.value })
                  }
                  value={limit_start}
                  type="date"
                  className="w-full"
