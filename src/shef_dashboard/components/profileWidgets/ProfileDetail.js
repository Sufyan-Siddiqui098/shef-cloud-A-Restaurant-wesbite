        ...
        <div>
            <div className='p-5 rounded-xl border border-borderClr mb-6'>
                <div className='flex md:flex-row flex-col items-center gap-4'>
                    <img src="/media/frontend/img//avatar.jpg" className="img-fluid !w-[200px] h-[210px] object-cover object-top rounded-lg" alt="Logo" />
                    <div className='sm:text-start text-center'>
                        <h2 className='text-xl font-bold mb-0'>Max Smith</h2>
                        <div className='flex items-center sm:justify-start justify-center gap-2'>
                            ...
                            <h3 className='text-lg font-medium text-headGray mb-0'>maxsmith@mail.com</h3>
                        </div>
                        <div className='flex items-center sm:justify-start justify-center gap-2'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="#a0a3a7">
                            ...
                            <h3 className='text-lg font-medium text-headGray mb-0'>0300 0000 000</h3>
                        </div>
