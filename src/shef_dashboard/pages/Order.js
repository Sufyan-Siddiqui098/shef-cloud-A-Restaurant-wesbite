...
export const Order = () => {
    ...
    const handleStatusChange = (e,id) => {
        ...
        const saveStatus = async () => {
            try {
                if(newStatus){
                    const ordersRetrieved = await handleChangeOrderStatus(authToken,{status:newStatus},id)
            ...
            <div className=''>
                ...
                <div className='container mx-auto p-5'>
                    <div className='mt-6 p-5 bg-white rounded-xl border border-borderClr'>
                        <div className=''>
                            <h3 className='text-xl font-semibold leading-tight pt-2 mb-3'>My Orders for <span>{new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span></h3>
                        </div>
                            ...
                            <div className='lg:col-span-4 md:col-span-6 col-span-12'>
                                <div className='flex relative'>
                                    <input className='w-full' placeholder='Search' onChange={handleOnChange} />
                        ...
                        <div>
                            <h3 className='text-xl font-semibold leading-tight uppercase pt-2 mb-3 mt-6 border-b pb-2'>Food item Count</h3>
                                ...
                                <table className="text-left w-full menuTable border-0">
                                    ...
                                    {orderDetails
                                        ...
                                        order.order_details?.map(detail => (
                                            ...
                                            <td>
                                                <p className='text-primaryGreen text-[14px]'>{order.order_code}</p>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <h4 className='text-[14px] mb-0 leading-tight'>{detail.user_menu?.spice_level?.name}</h4>{/*spice level id is only being sent*/}
                                            </td>
                                            <td>
                                                <h4 className='text-[14px] mb-0 leading-tight'>{detail.user_menu?.portion_size} grams</h4>
                                            </td>
                                            </tr>
                                        ))
                                        )
                                    ...
                                    <table className="text-left w-full menuTable border-0">
                                        ...
                                        order.order_details?.map(detail => (
                                            <tr className='border-b'>
                                                ...
                                                <td>
                                                    <h4 className='text-[14px] mb-0 leading-tight'>{detail.name}</h4>
                                                </td>
                                                <td>
                                                    <h4 className='text-[14px] mb-1 leading-tight'>- {new Date(order.delivery_time).toLocaleDateString()}</h4>
                                                    <h4 className='text-[14px] mb-1 leading-tight'>- {new Date(order.delivery_time).toLocaleDateString('en-US', { weekday: 'long' })}</h4>
                                                    <h4 className='text-[14px] mb-1 leading-tight'>- {new Date(order.delivery_time).toLocaleTimeString()}</h4>
                                                </td>
                                                <td>
                                                    <h4 className='text-[14px] mb-0 leading-tight'>{order.name}</h4>
                                                </td>
                                                {/* <td>
                                                ...
                                                <td>
                                                    <h4 className='text-[14px] mb-0 leading-tight'>{order.chef_earning_price.toLocaleString("en-PK", {
                                                        style: "currency",
                                                        currency: "PKR",
                                                        })}
                                                    </h4>
                                                ...
                                                <td>
                                                    <h4 className='text-[14px] mb-0 leading-tight'>{order.total_price.toLocaleString("en-PK", {
                                                        style: "currency",
                                                        currency: "PKR",
                                                        })}
                                                    </h4>
                                                ...
                                                <td>
                                                <select id="selectOption" defaultValue={order.status} onChange={(e)=> handleStatusChange(e,order.id)}>
